...
/*template void PrintNode<Rectangle>(std::ostream& os, std::shared_ptr<TNaryTree<Rectangle>::Node> node);
template void PrintNode<Rhombus>(std::ostream& os, std::shared_ptr<TNaryTree<Rhombus>::Node> node);
template void PrintNode<Trapezoid>(std::ostream& os, std::shared_ptr<TNaryTree<Trapezoid>::Node> node);

template <typename T> void PrintNode(std::ostream& os, std::shared_ptr<typename TNaryTree<typename T>::Node> node)
{
	os << node->t.Square();
	if (!node->child)
	{
